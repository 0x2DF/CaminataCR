<%@ Page Language="C#" AutoEventWireup="true" CodeFile="QualityLevel.aspx.cs" Inherits="QualityLevel" %>
        ...
        <div id="wrapper">
            ...
            <div id="page-wrapper">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-lg-12">
                            <h1 class="page-header">Niveles de calidad</h1>
                        </div>
                        <div class="col-lg-12">
                            <asp:Button ID="Button1" runat="server" Text="Agregar" class="btn btn-outline btn-success" OnClick="addQualityLevel" />
                        </div>
                        <div class="col-md-4 col-md-offset-4">
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body">
                                    <div id="qualityLevelS" class="table-responsive" runat="server"></div>
                                    <!-- /.table-responsive -->
                                </div>
                            </div>
                            <!-- /.container-fluid -->
