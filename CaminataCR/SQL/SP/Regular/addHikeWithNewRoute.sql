CREATE PROCEDURE dbo.addHikeWithNewRoute
    @UserId INT,
	@HikeId INT,
...
BEGIN
	...
	VALUES (@UserId, @HikeId, GETDATE(), @idTipoDeCaminata, @idNivelDeDificultad, @idNivelDePrecio, @idNivelDeCalidad, @image, @Comment)
