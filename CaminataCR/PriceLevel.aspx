<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PriceLevel.aspx.cs" Inherits="PriceLevel" %>
        ...
        <div id="wrapper">
            ...
            <div id="page-wrapper">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-lg-12">
                            <h1 class="page-header">Niveles de precio</h1>
                        </div>
                        <div class="col-lg-12">
                            <asp:Button ID="Button1" runat="server" Text="Agregar" class="btn btn-outline btn-success" OnClick="addPriceLevel" />
                        </div>
                        <div class="col-md-4 col-md-offset-4">
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body">
                                    <div id="priceLevelS" class="table-responsive" runat="server"></div>
                                    <!-- /.table-responsive -->
                                </div>
                            </div>
                            <!-- /.container-fluid -->
