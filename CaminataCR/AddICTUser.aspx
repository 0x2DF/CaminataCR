<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AddICTUser.aspx.cs" Inherits="AddICTUser" %>
        ...
        <div id="wrapper">
            ...
            <div id="page-wrapper">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-lg-12">
                            <h1 class="page-header">Agregar usuario ICT</h1>
                        </div>
                    </div>
                    <div class="col-md-3">
                        ...
                        <div class="form-group">
                            <asp:Button ID="a" runat="server" Text="Agregar" CssClass="btn btn-outline btn-success" BackColor="#269E22" BorderColor="#269E22" ForeColor="White" Font-Bold="True" onClick="CreateICTUser" />
                        </div>
                        <div class="form-group">
