<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AddDificultyLevel.aspx.cs" Inherits="addDificultyLevel" %>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                <asp:Label ID="Label1" runat="server" Text="Nivel de dificultad"></asp:Label>
                            </div>
                            <div class="form-group">
                                <asp:TextBox ID="dificulty" placeholder="Nivel de dificultad" class="form-control" required runat="server"></asp:TextBox>
