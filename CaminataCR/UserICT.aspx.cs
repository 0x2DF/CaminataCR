...
public partial class UserICT : System.Web.UI.Page
{
    ...
    protected void editUser(object sender, EventArgs e)
    {
        ...
        Response.Redirect("EditICTUser.aspx");
    }

    protected void addICT(object sender, EventArgs e)
    {
        Response.Redirect("AddICTUser.aspx");
    }
}