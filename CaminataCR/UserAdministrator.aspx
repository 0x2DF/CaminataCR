<%@ Page Language="C#" AutoEventWireup="true" CodeFile="UserAdministrator.aspx.cs" Inherits="UserAdministrator" %>
            ...
            <div id="page-wrapper">
                <div class="container-fluid">
                    <div class="row">
                        ...
                        <div class="col-lg-12">
                            <asp:Button ID="Button1" runat="server" Text="Agregar" class="btn btn-outline btn-success" OnClick="addAdministrator" />
                        </div>
                        <div class="col-md-4 col-md-offset-4">
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body">
                                    <div id="administratorS" class="table-responsive" runat="server"></div>
                                    <!-- /.table-responsive -->
                                </div>
                            </div>
                            <!-- /.container-fluid -->
