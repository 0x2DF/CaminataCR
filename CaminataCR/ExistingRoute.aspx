<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ExistingRoute.aspx.cs" Inherits="ExistingRoute" %>
					                                ...
					                                <div class="row">
						                                <div class="col-lg-12">
                                                            ...
                                                            <div class="form-group">
									                            ...
									                            <asp:DropDownList ID="dd_hiketype" runat="server" class="form-control">
                                                                </asp:DropDownList>
									                            <asp:RequiredFieldValidator id="RFV_hiketype"
                                                                    controltovalidate="dd_hiketype"
                                                                    validationgroup="end"
								                            ...
								                            <div class="form-group">
									                            ...
									                            <asp:DropDownList ID="dd_difficultylevel" runat="server" class="form-control">
                                                                </asp:DropDownList>
									                            <asp:RequiredFieldValidator id="RFV_difficultylevel"
                                                                    controltovalidate="dd_difficultylevel"
                                                                    validationgroup="end"
