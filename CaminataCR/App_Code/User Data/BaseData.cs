...
public class BaseData
{
    ...
    public SqlConnection ManageDatabaseConnection(string actionToPerform, string userType)
    {
        ...
        if (userType == "admin")
        {
            connectionString = "Data Source=DESKTOP-3VGUL7E;Integrated Security=False;User ID=admin;Password=admin;Connect Timeout=15;Encrypt=False;TrustServerCertificate=True;ApplicationIntent=ReadWrite;MultiSubnetFailover=False";
