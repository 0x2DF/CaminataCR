...
public class BaseData
{
    ...
    public SqlConnection ManageDatabaseConnection(string actionToPerform, string userType)
    {
        ...
        {
            connectionString = "Data Source=0X2F-;Integrated Security=False;User ID=regular;Password=regular;Connect Timeout=30;Encrypt=False;TrustServerCertificate=True;ApplicationIntent=ReadWrite;MultiSubnetFailover=False";
        }
        else
        {
            ...
            //connectionString = "Data Source=0X2F-;Integrated Security=True;Connect Timeout=30;Encrypt=False;TrustServerCertificate=True;ApplicationIntent=ReadWrite;MultiSubnetFailover=False";
