...
public partial class ManageFriends : System.Web.UI.Page
{
    ...
    private void displayFriends()
    {
        ...
        fb.LoadListOfFriends(ref regularUser);
    ...
    public LinkButton addLinkButton(int id)
    {
        ...
        lbtn.Click += new System.EventHandler(removeFriend);
        lbtn.Text = "<i class=\"fa fa-minus\"></i>";
        lbtn.CssClass = "btn btn-default";
        lbtn.ID = id.ToString();
        return lbtn;
    }

    protected void removeFriend(object sender, EventArgs e)
    {
        FriendBusiness fb = new FriendBusiness();
        RegularUser regularUser = (RegularUser)Session["REG_USER"];
        ...
        t = fb.RemoveFriend(ref regularUser, ref friend);
