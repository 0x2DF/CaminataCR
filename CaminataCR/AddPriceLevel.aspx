<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AddPriceLevel.aspx.cs" Inherits="AddPriceLevel" %>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                <asp:Label ID="Label1" runat="server" Text="Nivel de precio"></asp:Label>
                            </div>
                            <div class="form-group">
                                <asp:TextBox ID="price" placeholder="Nivel de precio" class="form-control" required runat="server"></asp:TextBox>

                            </div>
                            <div class="form-group">
                                <asp:Button ID="a" runat="server" Text="Agregar" CssClass="btn btn-outline btn-success" BackColor="#269E22" BorderColor="#269E22" ForeColor="White" Font-Bold="True" OnClick="CreatePriceLevel" />
                            </div>
                            <div class="form-group">
